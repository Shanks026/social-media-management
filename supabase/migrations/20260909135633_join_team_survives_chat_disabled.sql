...
-- agency_members row: signed in, belonging to nothing. Reproduced against the
-- live schema with chat = false: join_team raised, member row absent.
--
...
-- backfilled. A member skipped here is added the moment they open chat.
--
