CREATE OR REPLACE FUNCTION public.get_campaign_analytics(p_campaign_id uuid)
 RETURNS TABLE(total_posts bigint, published_posts bigint, on_time_posts bigint, avg_approval_days numeric, platform_distribution jsonb, budget numeric, total_invoiced numeric, total_collected numeric)
 LANGUAGE plpgsql
