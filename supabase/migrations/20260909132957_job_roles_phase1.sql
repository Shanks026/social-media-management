...
-- Seed only titles actually in use, so nobody loses the title they have and no
...
-- Assignment RPC. Deliberately separate from update_member_access: "change what
-- someone is called" and "change what someone can do" stay separately
-- auditable, and this avoids widening the surface of the function that sets
-- system_role.
