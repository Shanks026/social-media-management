...
RETURNS TABLE(id uuid, member_user_id uuid, system_role text, functional_role text, joined_at timestamp with time zone, email text, first_name text, last_name text, full_name text, avatar_url text)
LANGUAGE sql
