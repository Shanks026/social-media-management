...
-- for job titles. Every reader in src/ was migrated first.
--
...
--    title on the join form. Otherwise the reusable-links version from
--    20260909150000 (multi-use links, idempotent repeat click, /team link).
